...
def get_employees():
    ...
    try:
        ...
        emps = ({ 'first_name' : emp.first_name if emp.first_name else '',
                  ...
                  'employee_status_id' : emp.employee_status_id if emp.employee_status_id else '',
...
def get_certifications_by_emp(id):
    try:
        ...
        certs = ({
            ...
            'regulatory_body' : q.registration_body_name.name if q.registration_body_name else '',
